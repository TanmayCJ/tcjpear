...
---
A router decides which **<u>Agent</u>** in the **<u>Pool</u>** should run next. It examines the shared **<u>State</u>** or user input and chooses the agent best suited for the next step.
