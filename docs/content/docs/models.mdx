...
Models define which LLM your **<u>Agent</u>** or **<u>Pool</u>** uses. Peargent provides a simple, unified interface for connecting to different providers (OpenAI, Groq, Gemini, etc.).

Think of a Model as the brain of your **<u>Agent</u>** or **<u>Pool</u>**, the thing that actually generates responses.
